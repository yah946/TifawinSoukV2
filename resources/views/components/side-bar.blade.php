<aside class="sticky top-0 h-screen w-[15%]
    ...
    <nav class="flex flex-col gap-6 mt-6 items-start px-4">
        ...
        <a href="{{route('admin.categories.index')}}" class="flex items-center gap-3 text-white hover:text-green-400">
        ...
        <a href="{{route('logout')}}"
           class="flex items-center gap-3 text-white  mt-auto hover:text-red-500">
