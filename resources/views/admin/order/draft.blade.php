        ...
        <div class="mb-8">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Gérez les commandes qui n'ont pas encore été finalisées</p>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    <div class="text-2xl font-semibold text-gray-900">{{ $orders->count() > 0 ? number_format($orders->avg('total'), 2) : '0.00' }} DH</div>
                                </dd>
                            </dl>
                        </div>
                    </div>
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Les commandes en brouillon apparaîtront ici une fois créées.</p>
                </div>
            @endif
        </div>
    </div>
