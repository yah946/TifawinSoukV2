                ...
                <div class="px-4 py-5 sm:p-6">
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">Les informations du client ne sont plus disponibles</p>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="lg:col-span-2">
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:px-6 border-b border-gray-200">
                    ...
                    <p class="mt-1 text-sm text-gray-500">{{ $order->orderItems->count() }} article(s) dans cette commande</p>
                </div>
